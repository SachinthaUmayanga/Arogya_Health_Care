...
<?php include 'Header.php';?>
  ...
  <section class="h-100 bg-light">
    <form action="SDis.php" method="POST">
                ...
                if($conn){
                    if(isset($_GET['sid'])){
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $queUp="UPDATE staff SET FName='$fn',LName='$ln',SAddress='$sadd',Gender='$gen',DOB='$dob',Email='$em',NIC='$nic',TelNo='$tel',Designation='$des',Qualification='$qul' WHERE StaffID='$sid'";
                            if(mysqli_query($conn,$queUp)){
                                header("Location:SDis.php");
                            }
                        }
                    }
                    $queGet="SELECT * FROM staff WHERE StaffID='$sid'";
                    $res=mysqli_query($conn,$queGet);
                    $resData=mysqli_fetch_assoc($res);
                ?>
                  <h3 class="mb-5 text-uppercase">update staff id <?php echo $sid?></h3>
                  ...
                  <div class="form-outline mb-4">
                    <input type="text" id="txtAdd" name="txtAdd" class="form-control form-control-lg" maxlength="100" value="<?php echo $resData['SAddress']?>"/>
                  ...
                  <div class="form-outline mb-4">
                    <input type="text" id="txtDes" name="txtDes" class="form-control form-control-lg" maxlength="50" value="<?php echo $resData['Designation']?>"/>
                    <label class="form-label" for="form3Example90">Designation</label>
                  </div>

                  <div class="form-outline mb-4">
                    <input type="text" id="txtQul" name="txtQul" class="form-control form-control-lg" maxlength="100" value="<?php echo $resData['Qualification']?>"/>
